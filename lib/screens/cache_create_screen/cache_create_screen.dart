...
class CacheCreateScreen extends HookConsumerWidget {

  const CacheCreateScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final attachments = ref.watch(cacheCreateScreenControllerProvider).attachments;
    final title = ref.watch(cacheCreateScreenControllerProvider).title;
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          await ref.read(routerProvider.notifier).showBottomSheet(child: Column(
                            ...
                            children: [
                              ListTile(
                                ...
                                onTap: () {
                                  ...
                                  ref.read(routerProvider.notifier).push(route: Routes.media, extra: MediaRouteParams(attachmentType: attachment.type, onTapFunc: (file) async {
                                    ...
                                    await ref.read(cacheCreateScreenControllerProvider.notifier).updateAttachment(
                              ...
                              ListTile(
                                ...
                                onTap: () async {
                                  ref.read(routerProvider.notifier).closeBottomSheet();
                                  await ref.read(cacheCreateScreenControllerProvider.notifier).deleteAttachment(attachmentId: attachment.id!);
                                }
                              )
                            ],
                          ));
                      ...
                      TextField(
                        ...
                        onChanged: ref.read(cacheCreateScreenControllerProvider.notifier).setTitle,
                      ...
                      ConstrainedBox(
                        ...
                        child: TextField(
                          ...
                          onChanged: ref.read(cacheCreateScreenControllerProvider.notifier).setBody,
                          maxLines: null,
                          maxLength: 600,
                          decoration: const InputDecoration(
                            labelText: '本文',
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () => ref.read(routerProvider.notifier).push(route: Routes.media, extra: MediaRouteParams(attachmentType: AttachmentType.photo, onTapFunc: (file) async {
                          ref.read(routerProvider.notifier).pop();
                          final params = CreatePhotoParams(file: file);
                          await ref.read(cacheCreateScreenControllerProvider.notifier).addAttachment(attachmentType: AttachmentType.photo, data: params);
                        })),
