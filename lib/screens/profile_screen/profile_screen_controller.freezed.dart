...
class _$ProfileScreenStateTearOff {
  ...
  _ProfileScreenState call({User? user}) {
...
/// @nodoc
abstract class _$ProfileScreenStateCopyWith<$Res>
    implements $ProfileScreenStateCopyWith<$Res> {
  factory _$ProfileScreenStateCopyWith(
          _ProfileScreenState value, $Res Function(_ProfileScreenState) then) =
      __$ProfileScreenStateCopyWithImpl<$Res>;
  @override
  $Res call({User? user});
...
class __$ProfileScreenStateCopyWithImpl<$Res>
  ...
  __$ProfileScreenStateCopyWithImpl(
      _ProfileScreenState _value, $Res Function(_ProfileScreenState) _then)
      : super(_value, (v) => _then(v as _ProfileScreenState));

  @override
  _ProfileScreenState get _value => super._value as _ProfileScreenState;
...
class _$_ProfileScreenState implements _ProfileScreenState {
  const _$_ProfileScreenState({this.user});
  ...
  @JsonKey(ignore: true)
  @override
  _$ProfileScreenStateCopyWith<_ProfileScreenState> get copyWith =>
      __$ProfileScreenStateCopyWithImpl<_ProfileScreenState>(this, _$identity);
}

abstract class _ProfileScreenState implements ProfileScreenState {
  const factory _ProfileScreenState({User? user}) = _$_ProfileScreenState;
